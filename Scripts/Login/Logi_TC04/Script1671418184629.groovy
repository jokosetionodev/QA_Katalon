...
WebUI.click(findTestObject('Page_OrangeHRM/div_PasswordRequired'))

WebUI.click(findTestObject('Page_OrangeHRM/span_Required'))

WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/span_Required'), 0)

WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/div_PasswordRequired'), 0)
